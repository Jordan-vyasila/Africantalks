...
<html>
<head>
	<title>african talks create new account</title>
	<meta charset="utf-8">
...
<div class="col l12 m12 s12">
      <div class="container">
  <a href="#" onclick="window.location.href='index.php';" class="right hoverable">
    <h6>
      <u><b><i class="fa fa-edit"></i>Sign In</b></u>
    </h6></a>
</div>
<div class="container margin" style="margin-top: 7%;">
  <center>
    <img src="jlog1.png" width="102" height="102" style="object-fit: cover;border-radius: 50%;">
        ...
        <h3 class="center">Please Sign up here</h3>
